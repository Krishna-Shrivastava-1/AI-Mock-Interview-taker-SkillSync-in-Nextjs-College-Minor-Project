  ...
  return (
    <div>
      <div className='w-full '>
        ...
        {userDatafromparam?.user?.followers?.length > 0 ?
           userDatafromparam?.user?.followers?.map((e) => (
                                                <div key={e?._id}>
          ...
          :
           userDatafromparam?.user?.followers?.length === 0 ? <p className='text-center text-xl font-semibold my-4'>No Followers.</p> :
